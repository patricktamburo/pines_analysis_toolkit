...
if not os.path.exists(default_pines_dir):
    ...
    os.mkdir(default_pines_dir/'Calibrations/Flats/Domeflats/J/Master Flats Stddev/')
    ...
    os.mkdir(default_pines_dir/'Calibrations/Flats/Domeflats/H/Master Flats Stddev/')
    ...
    os.mkdir(default_pines_dir/'Calibrations/Darks/Master Darks Stddev/')
