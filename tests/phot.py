...
for target in targets:
    ...
    #pat.pwv.los_pwv_data_generator(target, ut_dates, centroided_sources, interp_type='cubicspline')

    #Perform photometry using a variety of methods. 
    #pat.photometry.aper_phot.fixed_aper_phot(target, centroided_sources, ap_radii=[3.0, 3.5, 4.0, 4.5, 5.0, 5.5, 6.0], an_in=9, an_out=30)
