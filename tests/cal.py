...
exptimes =   [        15,         30,         60]
dark_dates = ['20210526', '20210526', '20210526']
...
pat.data.make_calibrations(sftp, exptimes, bands, dark_dates, flat_dates, dark_starts=[], dark_stops=[], lights_on_starts=[], lights_on_stops=[], lights_off_starts=[], lights_off_stops=[])
