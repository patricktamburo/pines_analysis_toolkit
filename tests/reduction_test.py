...
for target in targets:
    ...
    sources = pat.photometry.ref_star_chooser(target, restore=False, source_detect_image_ind=130, 
                exclude_lower_left=False, dimness_tolerance=0.5, brightness_tolerance=3.0, distance_from_target=900., non_linear_limit=3300, edge_tolerance=250., source_detect_plot=False)
