...
'''Authors:
	...
	Inputs:
        ...
        guess_position (tuple of floats, optional): Guess of targets position (x pixel, y pixel) in the image for which source detection was performed. By default, (705, 386).
    Outputs:
        target_id (int): the id of the target in the source table that most closely matches guess_position
	TODO:
'''
def target_finder(sources, guess_position=(705.,386.)):
